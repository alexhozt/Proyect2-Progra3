...
with tabs[0]:
    ...
    if st.button("🚀 Ejecutar Simulación"):
        ...
        # ===== Crear nodos y aristas de forma aleatoria =====
        import random
        import string
...
with tabs[1]:
    ...
    if st.session_state.get("sim_started") and "graph" in st.session_state:
        from network_adapter import NetworkXAdapter
...
with tabs[3]:
    ...
    if st.session_state.get("sim_started"):
        ...
        # Simulación mínima de AVL con un solo nodo
        class DummyAVLNode:
        ...
        st.warning("⚠️ Ejecuta una simulación para ver las rutas más frecuentes.")
